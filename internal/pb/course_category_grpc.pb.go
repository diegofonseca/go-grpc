...
type CategoryServiceClient interface {
	...
	ListCategory(ctx context.Context, in *Search, opts ...grpc.CallOption) (*Categories, error)
...
func (c *categoryServiceClient) ListCategory(ctx context.Context, in *Search, opts ...grpc.CallOption) (*Categories, error) {
	out := new(Categories)
...
type CategoryServiceServer interface {
	...
	ListCategory(context.Context, *Search) (*Categories, error)
...
func (UnimplementedCategoryServiceServer) ListCategory(context.Context, *Search) (*Categories, error) {
...
func _CategoryService_ListCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).ListCategory(ctx, req.(*Search))
	}
	return interceptor(ctx, in, info, handler)
}
